...
$tabtermrelationships = $DB_PREFIX . 'term_relationships';
    ...
    isset($_GET['searchterm']) ? $searchterm = mysqli_real_escape_string($link, $_GET['searchterm']) : $searchterm = NULL;
    ...
    if(isset($_GET['slug'])){
        $query .=  " AND t.slug = '" .  mysqli_real_escape_string($link, $_GET['slug'])  . "'";
    }
